...
bit isSelected=0,updateStaffFlag=0,stateAdFlag=0,brightAdFlag=0,inSetting=0,inAddrSetting=0,isInfraredAllowed=0,isdebug=1,timeChanged=0,startSetting=0;
